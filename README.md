...
The following figure shows the free body diagram of a quadrotor, together with two coordinate frames, the inertial (**a**<sub>1</sub>, **a**<sub>2</sub>, **a**<sub>3</sub>) and the body-fixed (**b**<sub>1</sub>, **b**<sub>2</sub>, **b**<sub>3</sub>) reference frames, and its center of mass *C*.

![alt text][image1]

The principal axes are parallel to the body-fixed reference frames axes. Therefore, the inertia tensor is diagonal.
